...
//! 2. Global upstream — fallback
//! 3. No upstream — return None
...
mod tests {
    ...
    fn local_scopes_takes_precedence_over_scope_rules() {
        ...
        // local_scopes deny-list should win over scope_rules
    ...
    fn extract_scope_works() {
        ...
        assert_eq!(extract_scope("@solo"), None); // No slash, not a valid scope
    }
}
